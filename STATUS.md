...
CoronerChat **2.7.12** is a Windows-focused Electron application with a local web UI and OBS Browser Source endpoints.
...
- YouTube Live: chat read/send through the supported authenticated desktop flow.
