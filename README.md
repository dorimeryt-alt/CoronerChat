...
Актуальная сборка: [Releases → Latest](https://github.com/dorimeryt-alt/CoronerChat/releases/latest) — **v2.7.21**.
...
- Автор: [C0R0N3R](docs/wiki/Author.md) · Telegram [@coroner_of_autopsy](https://t.me/coroner_of_autopsy) · [DonationAlerts](https://www.donationalerts.com/r/coroner_of_autopsy)
