...
- Команды приложения `/*` из поля CoronerChat и с Twitch / VK / Kick / YouTube / Rutube — только со своего вошедшего аккаунта
- У стримера сырой `/*` не идёт в ленту и OBS overlay: короткое уведомление `admin: уведомления off`
