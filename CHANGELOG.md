...
Предпросмотр десктопа на WebView2 (Tauri). **GitHub Latest не меняется** — стабильный канал остаётся Electron **2.7.16**. Этот тег — pre: в приложении Настройки → Обновления → канал «включая prerelease».
...
Не ставь поверх 2.7.16, если хочешь остаться на Electron Latest.
